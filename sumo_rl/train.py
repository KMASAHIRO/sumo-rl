...
def train_agent(
    ...
    embedding_no_train=False, embedding_start_train=None, reward_csv=None, loss_csv=None, device="cpu", 
    seed="random", port=None, logger=None):
    ...
    env = SumoEnvironment(net_file=net_file,
                          ...
                          reward_type=reward_type, port=port, single_agent=False, seed=seed)
